...
const QUESTION_REPOSITORY = [
    ...
    // --- HUMAN BODY (DIGESTION & SYSTEMS) ---
    { q: "Where does food go after the stomach?", a: "Small intestine", options: ["Large intestine", "Small intestine", "Kidneys"] },
    { q: "What happens to undigested food?", a: "Removed from body", options: ["Absorbed", "Removed from body", "Sent to heart"] },
    { q: "Which gas is a waste product of respiration?", a: "Carbon Dioxide", options: ["Oxygen", "Nitrogen", "Carbon Dioxide"] },
    { q: "What sound does the heart make?", a: "Lub-dub", options: ["Tick-tock", "Lub-dub", "Whoosh"] },
    { q: "What is the pumping action of the heart called?", a: "Circulation", options: ["Digestion", "Respiration", "Circulation"] },
    { q: "Which organ protects the body from heat and cold?", a: "Skin", options: ["Muscle", "Bone", "Skin"] },
    { q: "What connects the kidneys to the urinary bladder?", a: "Ureters", options: ["Arteries", "Ureters", "Nerves"] },
    { q: "Which organ stores urine before releasing it?", a: "Urinary bladder", options: ["Kidney", "Stomach", "Urinary bladder"] },
    { q: "Sweat is removed through which organ?", a: "Skin", options: ["Lungs", "Skin", "Kidneys"] },
    { q: "Which system controls blood flow?", a: "Circulatory", options: ["Digestive", "Circulatory", "Excretory"] },
    { q: "What enters the blood in the small intestine?", a: "Useful substances", options: ["Waste", "Useful substances", "Air"] },
    { q: "What connects the mouth to the stomach?", a: "Food pipe", options: ["Windpipe", "Food pipe", "Vein"] },
    { q: "Which lung is slightly smaller?", a: "Left lung", options: ["Right lung", "Left lung", "Both are same"] },
    { q: "Why is the left lung smaller?", a: "To fit the heart", options: ["To fit the stomach", "To fit the heart", "No reason"] },
    { q: "What do cells combine to form?", a: "Tissue", options: ["Organs", "Tissue", "Bones"] },

    // --- FOOD & HEALTH ---
    { q: "Which food item is rich in carbohydrates?", a: "Rice", options: ["Fish", "Rice", "Spinach"] },
    { q: "Which food item is rich in fats?", a: "Butter", options: ["Bread", "Butter", "Apple"] },
    { q: "Which food item is a source of protein?", a: "Pulses/Dal", options: ["Sugar", "Potato", "Pulses/Dal"] },
    { q: "What happens if we cook food too much?", a: "Vitamins are lost", options: ["It gets harder", "Vitamins are lost", "It becomes poisonous"] },
    { q: "Why do we need water in digestion?", a: "To digest food", options: ["To make blood", "To digest food", "To cool down"] },
    { q: "How does the body lose water?", a: "Sweat and Urine", options: ["Thinking", "Sweat and Urine", "Sleeping"] },
    { q: "What does 'balanced diet' mean?", a: "Correct amounts", options: ["Only tasty food", "Correct amounts", "Only fruits"] },
    { q: "Which vegetable should be eaten raw?", a: "Cucumber", options: ["Potato", "Brinjal", "Cucumber"] },
    { q: "What helps to remove waste from the digestive system?", a: "Fibre", options: ["Fats", "Fibre", "Sugar"] },
    { q: "Stale or spoilt food has a bad ___?", a: "Smell/Taste", options: ["Shape", "Smell/Taste", "Price"] },
    { q: "When should you wash fruits?", a: "Before eating", options: ["After eating", "Before eating", "Never"] },
    { q: "What gives warmth to the body?", a: "Fats", options: ["Water", "Fats", "Vitamins"] },
    { q: "Which nutrient repairs injured body parts?", a: "Proteins", options: ["Carbohydrates", "Proteins", "Fats"] },
    { q: "Sugar and bread are rich in what?", a: "Carbohydrates", options: ["Proteins", "Carbohydrates", "Minerals"] },
    { q: "What helps the body fight illness?", a: "Vitamins/Minerals", options: ["Fats", "Vitamins/Minerals", "Sugar"] },

    // --- PLANTS ---
    { q: "What is the flat surface of a leaf called?", a: "Lamina", options: ["Midrib", "Lamina", "Stalk"] },
    { q: "What are the fine lines on a leaf called?", a: "Veins", options: ["Wires", "Veins", "Roots"] },
    { q: "Why are leaves called food factories?", a: "They make food", options: ["They store water", "They make food", "They are green"] },
    { q: "Which gas do plants take in to make food?", a: "Carbon Dioxide", options: ["Oxygen", "Carbon Dioxide", "Nitrogen"] },
    { q: "Where do plants store extra food?", a: "Leaves/Stem/Roots", options: ["Soil", "Air", "Leaves/Stem/Roots"] },
    { q: "What does a flower turn into?", a: "Fruit", options: ["Leaf", "Root", "Fruit"] },
    { q: "Which plant has a fibrous root?", a: "Grass", options: ["Bean", "Mango", "Grass"] },
    { q: "Which plant has a taproot?", a: "Mustard", options: ["Wheat", "Mustard", "Rice"] },
    { q: "What is the stem of a tree called?", a: "Trunk", options: ["Branch", "Trunk", "Bark"] },
    { q: "What carries water from roots to leaves?", a: "Stem", options: ["Flower", "Stem", "Fruit"] },
    { q: "Which plants have soft green stems?", a: "Herbs", options: ["Trees", "Shrubs", "Herbs"] },
    { q: "Which plants have hard woody stems?", a: "Shrubs", options: ["Herbs", "Shrubs", "Climbers"] },
    { q: "Which fruit has many seeds?", a: "Watermelon", options: ["Mango", "Watermelon", "Plum"] },
    { q: "Which fruit has only one seed?", a: "Mango", options: ["Papaya", "Orange", "Mango"] },
    { q: "What helps a flower form a fruit?", a: "Bees", options: ["Wind", "Bees", "Rain"] },

    // --- ANIMALS & HABITATS ---
    { q: "What animal collects and stores food for winter?", a: "Himalayan Pika", options: ["Tiger", "Himalayan Pika", "Elephant"] },
    { q: "Where does the Indian Wild Ass live?", a: "Deserts", options: ["Forests", "Deserts", "Rivers"] },
    { q: "Which animal lives in cold polar regions?", a: "Polar Bear", options: ["Lion", "Polar Bear", "Camel"] },
    { q: "What is the lifespan of a housefly?", a: "1 month", options: ["1 year", "1 month", "1 week"] },
    { q: "What is the lifespan of a giant tortoise?", a: "150 years", options: ["50 years", "150 years", "300 years"] },
    { q: "How long does a pine tree live?", a: "300 years", options: ["100 years", "300 years", "500 years"] },
    { q: "What is the 'Touch-me-not' response called?", a: "Response to stimuli", options: ["Growth", "Response to stimuli", "Movement"] },
    { q: "Where do earthworms live?", a: "Wet soil", options: ["Dry sand", "Wet soil", "Trees"] },
    { q: "What happens if an earthworm's skin dries?", a: "It dies", options: ["It sleeps", "It dies", "It becomes a beetle"] },
    { q: "Which animal shoots water at insects?", a: "Archerfish", options: ["Shark", "Archerfish", "Whale"] },
    { q: "Who is known as the 'Birdman of India'?", a: "Dr. Salim Ali", options: ["Gandhi", "Dr. Salim Ali", "Nehru"] },
    { q: "Where is the Great Banyan Tree located?", a: "Kolkata", options: ["Delhi", "Mumbai", "Kolkata"] },
    { q: "Which plant eats insects?", a: "Pitcher plant", options: ["Rose", "Pitcher plant", "Tulsi"] },
    { q: "What do snakes use to move?", a: "Scales/Slither", options: ["Legs", "Scales/Slither", "Fins"] },
    { q: "Which animal breathes through its skin?", a: "Frog (in water)", options: ["Dog", "Frog (in water)", "Fish"] },

    // --- FEEDING HABITS ---
    { q: "What kind of teeth do cows have?", a: "Flat and broad", options: ["Sharp", "Flat and broad", "No teeth"] },
    { q: "What is chewing the cud?", a: "Chewing later", options: ["Eating fast", "Chewing later", "Drinking water"] },
    { q: "Which animal gnaws its food?", a: "Rabbit", options: ["Lion", "Rabbit", "Cow"] },
    { q: "What helps a frog catch insects?", a: "Sticky tongue", options: ["Teeth", "Sticky tongue", "Claws"] },
    { q: "What does a butterfly use to drink nectar?", a: "Tube mouth", options: ["Beak", "Tube mouth", "Teeth"] },
    { q: "What does a mosquito feed on?", a: "Blood", options: ["Grass", "Blood", "Bread"] },
    { q: "What starts every food chain?", a: "Plants", options: ["Animals", "Plants", "Sun"] },
    { q: "Which bird eats mice at night?", a: "Owl", options: ["Parrot", "Owl", "Sparrow"] },
    { q: "What do sharks use to kill fish?", a: "Sharp teeth", options: ["Beak", "Sharp teeth", "Tail"] },
    { q: "What do we call animals that hunt others?", a: "Predators/Carnivores", options: ["Prey", "Predators/Carnivores", "Herbivores"] },
    { q: "What helps an elephant break branches?", a: "Trunk", options: ["Legs", "Trunk", "Ears"] },
    { q: "What helps a giraffe reach tall trees?", a: "Long neck", options: ["Long legs", "Long neck", "Tail"] },
    { q: "What does a lizard eat?", a: "Insects", options: ["Grass", "Insects", "Fruits"] },
    { q: "Which animal swallows its food whole?", a: "Snake", options: ["Rat", "Snake", "Cat"] },
    { q: "Is a bear a herbivore or omnivore?", a: "Omnivore", options: ["Herbivore", "Carnivore", "Omnivore"] },

    // --- BIRDS ---
    { q: "What produces oil in water birds?", a: "Oil glands", options: ["Skin", "Oil glands", "Feathers"] },
    { q: "Why do ducks have oil on feathers?", a: "To stay dry", options: ["To look shiny", "To stay dry", "To fly fast"] },
    { q: "Which feathers give shape to a bird?", a: "Body feathers", options: ["Down feathers", "Body feathers", "Flight feathers"] },
    { q: "Which feathers are long and flat?", a: "Flight feathers", options: ["Down feathers", "Body feathers", "Flight feathers"] },
    { q: "What helps birds hear?", a: "Tiny holes", options: ["Large ears", "Tiny holes", "Antennae"] },
    { q: "Where are a bird's ears located?", a: "Behind eyes", options: ["On beak", "Behind eyes", "On wings"] },
    { q: "Which bird has a curved beak for nuts?", a: "Parakeet", options: ["Duck", "Parakeet", "Eagle"] },
    { q: "Which bird has a short hard beak?", a: "Pigeon", options: ["Eagle", "Pigeon", "Duck"] },
    { q: "Which bird has a chisel-like beak?", a: "Woodpecker", options: ["Sparrow", "Woodpecker", "Owl"] },
    { q: "Which bird wades in water?", a: "Egret/Crane", options: ["Sparrow", "Egret/Crane", "Parrot"] },
    { q: "What kind of legs do wading birds have?", a: "Long and slender", options: ["Short and thick", "Long and slender", "Webbed"] },
    { q: "Which bird runs very fast?", a: "Ostrich", options: ["Penguin", "Ostrich", "Duck"] },
    { q: "How many toes does an ostrich have?", a: "Two", options: ["Four", "Two", "Three"] },
    { q: "Which bird makes a nest on the ground?", a: "Peacock", options: ["Crow", "Peacock", "Parrot"] },
    { q: "Which bird uses a hole in a tree?", a: "Owl/Parrot", options: ["Weaver bird", "Owl/Parrot", "Tailor bird"] },

    // --- INSECTS ---
    { q: "How many parts is an insect body divided into?", a: "Three", options: ["Two", "Three", "Four"] },
    { q: "What are the three parts of an insect?", a: "Head, Thorax, Abdomen", options: ["Head, Neck, Legs", "Head, Thorax, Abdomen", "Face, Body, Tail"] },
    { q: "How many pairs of wings do insects usually have?", a: "Two pairs", options: ["One pair", "Two pairs", "Three pairs"] },
    { q: "What is the second stage of a butterfly?", a: "Larva", options: ["Pupa", "Larva", "Egg"] },
    { q: "What emerges from the pupa?", a: "Adult", options: ["Egg", "Larva", "Adult"] },
    { q: "Which insect eats wood?", a: "Termite", options: ["Ant", "Termite", "Fly"] },
    { q: "Which insect eats animal dung?", a: "Dung beetle", options: ["Ladybird", "Dung beetle", "Bee"] },
    { q: "Which insect eats pests on plants?", a: "Ladybird", options: ["Locust", "Ladybird", "Mosquito"] },
    { q: "Which insect carries germs/dirt?", a: "Housefly", options: ["Bee", "Housefly", "Butterfly"] },
    { q: "What is the sweet liquid in flowers?", a: "Nectar", options: ["Honey", "Nectar", "Juice"] },
    { q: "Where do termites live?", a: "Termite mound", options: ["Hive", "Web", "Termite mound"] },
    { q: "Do all insects have wings?", a: "No", options: ["Yes", "No", "Maybe"] },
    { q: "Which insect is a social insect?", a: "Ant/Bee", options: ["Fly", "Ant/Bee", "Beetle"] },
    { q: "What helps insects feel and smell?", a: "Feelers", options: ["Nose", "Feelers", "Feet"] },
    { q: "What are young ones of insects called?", a: "Larvae", options: ["Babies", "Larvae", "Cubs"] },
];
